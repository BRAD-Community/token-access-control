...
TEXT_MESSAGES = {
    "ru": {
        ...
        "main_menu": (
            ...
            "🤖👋 <b>Приветствую</b>\n\n"
            "Я здесь, чтобы помочь тебе пройти верификацию и получить доступ в приватный клубу Брэда. "
            "Давай начнем 👌 "
            "Клуб охраняется и для доступа тебе необходимо иметь что-нибудь из перечисленного \n\n"
        ...
        "deny_access": (
            ...
            "Не грусти, ты можешь <b>приобрести необходимые токены, перейдя по кнопкам</b> ниже и повторить попытку."
        ),
        "allow_access": (
